package com.hipposoft.counting;
...
class CombinationIterator implements CountingIterator {
	...
	public static void main(String[] args) {
		...
		CombinationIterator iter = CombinationIterator.combIterator(elements.length, 3);
		List<String> elemList = Arrays.asList(elements);
		while (iter.hasNext()) {
			System.out.println(iter.next(elemList));
		}
	}
	...
	public <E> List<E> next(List<E> list) {
		...
		return CountingUtils.reOrganizeList(next(), list);
	}
